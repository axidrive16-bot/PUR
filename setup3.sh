#!/bin/bash
# ═══════════════════════════════════════════════════════════════════
# HalalScreen — Mise à jour endpoints FMP → /stable/
# ═══════════════════════════════════════════════════════════════════
set -e
echo "🔄 Mise à jour des endpoints FMP..."

cat > src/lib/fmp.ts << 'EOF'
...
echo "✅ Endpoints FMP mis à jour !"
echo ""
echo "Relance le serveur : npm run dev"
echo "Teste : http://localhost:3000/api/stock/AAPL"
